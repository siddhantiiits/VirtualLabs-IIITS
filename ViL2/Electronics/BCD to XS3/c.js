...
if((image1==1) && (image3==0) &&(image8==1) &&(image10==0))
{
    alert("Don't Care Condition!");
}
else if((image1==1) && (image3==0) &&(image8==1) &&(image10==1))
{
    alert("Don't Care Condition!");
}
else if((image1==1) && (image3==1) &&(image8==0) &&(image10==0))
{
    alert("Don't Care Condition!");
}
else if((image1==1) && (image3==1) &&(image8==0) &&(image10==1))
{
    alert("Don't Care Condition!");
}
else if((image1==1) && (image3==1) &&(image8==1) &&(image10==0))
{
    alert("Don't Care Condition!");
}
else if((image1==1) && (image3==1) &&(image8==1) &&(image10==1))
{
    alert("Don't Care Condition!");
}
